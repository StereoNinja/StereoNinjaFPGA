...
void VDebayer::_settle__TOP__2(VDebayer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VDebayer::_settle__TOP__2\n"); );
    VDebayer* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VDebayer::_initial__TOP__4(VDebayer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VDebayer::_initial__TOP__4\n"); );
    VDebayer* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VDebayer::_ctor_var_reset() {
    ...
    { int __Vi0=0; for (; __Vi0<9; ++__Vi0) {
            Debayer__DOT__raw_pix[__Vi0] = VL_RAND_RESET_I(8);
    }}

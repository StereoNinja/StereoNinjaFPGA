...
void VDebayer_sim::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgIData(oldp+1,(vlTOPp->Debayer_sim__DOT__ramdata),32);
            tracep->chgCData(oldp+2,(vlTOPp->Debayer_sim__DOT__counter),8);
            tracep->chgIData(oldp+3,(vlTOPp->Debayer_sim__DOT__color_w),32);
            tracep->chgCData(oldp+4,(vlTOPp->Debayer_sim__DOT__raw_v),8);
            tracep->chgBit(oldp+5,((1U & (IData)(vlTOPp->Debayer_sim__DOT__debay__DOT__green_r))));
            tracep->chgCData(oldp+6,(vlTOPp->Debayer_sim__DOT__debay__DOT__green_r),8);
            tracep->chgCData(oldp+7,(vlTOPp->Debayer_sim__DOT__debay__DOT__red_r),8);
            tracep->chgCData(oldp+8,(vlTOPp->Debayer_sim__DOT__debay__DOT__blue_r),8);
            tracep->chgIData(oldp+9,(vlTOPp->Debayer_sim__DOT__debay__DOT__cX),32);
            tracep->chgIData(oldp+10,(vlTOPp->Debayer_sim__DOT__debay__DOT__cY),32);
            tracep->chgCData(oldp+11,(vlTOPp->Debayer_sim__DOT__debay__DOT__line_sel),2);
            tracep->chgIData(oldp+12,(vlTOPp->Debayer_sim__DOT__debay__DOT__address_out_r),19);
        ...
        tracep->chgBit(oldp+22,(vlTOPp->clock));
        tracep->chgBit(oldp+23,(vlTOPp->reset));
        tracep->chgIData(oldp+24,(vlTOPp->address_in),19);
        tracep->chgCData(oldp+25,(vlTOPp->red),8);
        tracep->chgCData(oldp+26,(vlTOPp->green),8);
        tracep->chgCData(oldp+27,(vlTOPp->blue),8);
        tracep->chgIData(oldp+28,((0x1ffffU & (vlTOPp->address_in 
                                               >> 2U))),17);
    }
}

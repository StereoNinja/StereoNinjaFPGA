...
void Vulx3s_pass_through_sim::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vulx3s_pass_through_sim::eval\n"); );
    Vulx3s_pass_through_sim__Syms* __restrict vlSymsp = this->__VlSymsp;  // Setup global symbol table
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("ulx3s_pass_through_sim.v", 1, "",
...
void Vulx3s_pass_through_sim::_eval_initial_loop(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__4(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    SData/*10:0*/ __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX;
    SData/*10:0*/ __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY;
    IData/*31:0*/ __Vdly__ulx3s_pass_through_sim__DOT__color_w;
    // Body
    __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY 
        = vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY;
    __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX 
        = vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX;
    __Vdly__ulx3s_pass_through_sim__DOT__color_w = vlTOPp->ulx3s_pass_through_sim__DOT__color_w;
    __Vdly__ulx3s_pass_through_sim__DOT__counter = vlTOPp->ulx3s_pass_through_sim__DOT__counter;
    if (vlTOPp->reset) {
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder1__DOT__q_out1 = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder2__DOT__q_out1 = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder0__DOT__q_out1 = 0U;
    } else {
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder1__DOT__q_out1 
            = ((0U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                ? 0x354U : ((1U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                             ? ((IData)(vlTOPp->reset)
                                 ? 0U : (0x3ffU & (
                                                   ...
                                                   | (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder1__DOT__q_out2p2) 
                                                       << 8U) 
                                                      | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder1__DOT__q_out2p3)))))
                             : 0U));
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder2__DOT__q_out1 
            = ((0U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                ? 0x354U : ((1U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                             ? ((IData)(vlTOPp->reset)
                                 ? 0U : (0x3ffU & (
                                                   ...
                                                   | (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder2__DOT__q_out2p2) 
                                                       << 8U) 
                                                      | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder2__DOT__q_out2p3)))))
                             : 0U));
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder0__DOT__q_out1 
            = (0x3ffU & ((0U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                          ? ((2U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT____Vcellinp__encoder0__H_VSync_Ctr))
                              ? ((1U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT____Vcellinp__encoder0__H_VSync_Ctr))
                                  ? 0x2abU : 0x154U)
                              : ((1U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT____Vcellinp__encoder0__H_VSync_Ctr))
                                  ? 0xabU : 0x354U))
                          : ((1U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                              ? ((IData)(vlTOPp->reset)
                                  ? 0U : (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder0__DOT__q_out2p1) 
                                           << 9U) | 
                                          (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder0__DOT__q_out2p2) 
                                            << 8U) 
                                           | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder0__DOT__q_out2p3))))
                              : 0U)));
    }
    if (vlTOPp->reset) {
        ...
        if ((0U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))) {
            vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__encoder0__DOT__cnt_old = 0U;
        }
    }
    if (vlTOPp->reset) {
    ...
    vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__hSync 
        = ((IData)(vlTOPp->reset) ? 0U : (1U & ((0x290U 
                                                 <= (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX)) 
                                                & (0x2f0U 
                                                   > (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX)))));
    if (vlTOPp->reset) {
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r = 0U;
        __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX = 0U;
    } else {
        if ((0x31fU == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX))) {
            __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX = 0U;
        } else {
            __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX 
                = (0x7ffU & ((IData)(1U) + (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX)));
            vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r 
                = (0x1fffffU & ((1U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea))
                                 ? ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r)
                                 : vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r));
        }
        vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__vSync 
            = ((((0x1eaU <= (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY)) 
                 & (0x1ecU > (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY))) 
                & (0x31eU > (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX))) 
               | ((0x1e9U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY)) 
                  & (0x31eU <= (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX))));
        if ((0x31fU == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX))) {
            if ((0x20cU == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY))) {
                __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY = 0U;
                vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r = 0U;
            } else {
                __Vdly__ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY 
                    = (0x7ffU & ((IData)(1U) + (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY)));
                vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r 
                    = (0x1fffffU & vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r);
            }
        }
    }
    if ((3U <= (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__counter))) {
        __Vdly__ulx3s_pass_through_sim__DOT__counter = 0U;
        __Vdly__ulx3s_pass_through_sim__DOT__color_w 
            = vlTOPp->ulx3s_pass_through_sim__DOT__ramdata;
    } else {
        __Vdly__ulx3s_pass_through_sim__DOT__counter 
            = (0xffU & ((IData)(1U) + (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__counter)));
        __Vdly__ulx3s_pass_through_sim__DOT__color_w 
            = (0xffffffU & (vlTOPp->ulx3s_pass_through_sim__DOT__color_w 
                            >> 8U));
    }
    vlTOPp->ulx3s_pass_through_sim__DOT__red_v = (0xffU 
                                                  & vlTOPp->ulx3s_pass_through_sim__DOT__color_w);
    vlTOPp->ulx3s_pass_through_sim__DOT__color_w = __Vdly__ulx3s_pass_through_sim__DOT__color_w;
    vlTOPp->ulx3s_pass_through_sim__DOT__counter = __Vdly__ulx3s_pass_through_sim__DOT__counter;
    ...
    vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__DrawArea 
        = ((IData)(vlTOPp->reset) ? 0U : (3U & ((0x280U 
                                                 > (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterX)) 
                                                & (0x1e0U 
                                                   > (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__CounterY)))));
    vlTOPp->ulx3s_pass_through_sim__DOT__ramdata = 
        ((0x12bffU >= (0x1ffffU & (vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r 
                                   >> 2U))) ? vlTOPp->ulx3s_pass_through_sim__DOT__DPR__DOT__ram
         [(0x1ffffU & (vlTOPp->ulx3s_pass_through_sim__DOT__HDMI__DOT__addr_r 
                       >> 2U))] : 0U);
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__8(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r1;
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r1 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r0;
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r0 
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__10(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__IDDR__DOT__C 
            = vlTOPp->cam0_d1;
    }
    if ((1U & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2)))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__IDDR__DOT__A 
            = vlTOPp->cam0_d1;
    }
    if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__IDDR__DOT__C 
            = vlTOPp->cam0_d0;
    }
    if ((1U & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2)))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__IDDR__DOT__A 
            = vlTOPp->cam0_d0;
    }
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__div2__DOT__counter 
        = ((IData)(vlTOPp->reset) ? 0U : (0xffU & ((IData)(1U) 
                                                   + (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__div2__DOT__counter))));
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__11(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    // Body
    if ((1U & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2)))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__IDDR__DOT__D1 
            = vlTOPp->cam0_d1;
    }
    if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__IDDR__DOT__B 
            = vlTOPp->cam0_d1;
    }
    if ((1U & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2)))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__IDDR__DOT__D1 
            = vlTOPp->cam0_d0;
    }
    if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync_mipi_clk_2) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__IDDR__DOT__B 
            = vlTOPp->cam0_d0;
    }
}
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__12(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    CData/*0:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r;
    CData/*7:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r;
    CData/*7:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte0_r;
    CData/*7:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__counter;
    CData/*7:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter;
    // Body
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte0_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte0_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter;
    ...
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__counter 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__counter;
    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__byte_o_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__byte_o_r;
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        ...
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__syncbyte 
            = (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__ddr) 
                << 4U) | (0xfU & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__syncbyte) 
                                  >> 4U)));
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__syncbyte 
            = (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__ddr) 
                << 4U) | (0xfU & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__syncbyte) 
                                  >> 4U)));
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__byte_o_r_s = 0U;
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__byte_o_r_old = 0xb8U;
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__byte_o_r_s = 0U;
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__byte_o_r_old = 0xb8U;
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__even_r = 0U;
    } else {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r 
            = (((0U == (0xb8U ^ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__syncbyte))) 
                | (0U == (0x2eU ^ (0x3fU & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__syncbyte)))))
                ? 1U : (1U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r)));
        if (((0U == (0xb8U ^ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__syncbyte))) 
             & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r)))) {
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__even_r = 1U;
        }
        if (((0U == (0x2eU ^ (0x3fU & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__syncbyte)))) 
             & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r)))) {
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__even_r = 0U;
        }
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte0_r = 0U;
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r = 0U;
    } else {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte0_r 
            = (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__q_o_r) 
                << 4U) | (0xfU & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte0_r) 
                                  >> 4U)));
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r 
            = (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__q_o_r) 
                << 4U) | (0xfU & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r) 
                                  >> 4U)));
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__byte_o_r = 0U;
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter = 0U;
    } else {
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync) {
            __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter 
    ...
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__byte_o_r = 0U;
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__counter = 0U;
    } else {
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync) {
            __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__counter 
    ...
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte1_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte1_r = 0U;
    } else {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte1_r 
            = ((0xc0U & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__q_o_r) 
                         << 6U)) | (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__ov_fl_r) 
                                     << 4U) | (0xfU 
                                               & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA1__DOT__byte1_r) 
                                                  >> 4U))));
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte1_r 
            = ((0xc0U & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__q_o_r) 
                         << 6U)) | (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__ov_fl_r) 
                                     << 4U) | (0xfU 
                                               & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte1_r) 
                                                  >> 4U))));
    }
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__div4__DOT__counter 
        = ((IData)(vlTOPp->reset) ? 0U : (0xffU & ((IData)(1U) 
                                                   + (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__div4__DOT__counter))));
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r 
        = __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__sync_r;
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter 
        = __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__counter;
    ...
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r 
        = __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__BA0__DOT__byte0_r;
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__even_r = 0U;
    } else {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r 
            = (((0U == (0xb8U ^ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__syncbyte))) 
                | (0U == (0x2eU ^ (0x3fU & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__syncbyte)))))
                ? 1U : (1U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r)));
        if (((0U == (0xb8U ^ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__syncbyte))) 
             & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r)))) {
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__even_r = 1U;
        }
        if (((0U == (0x2eU ^ (0x3fU & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__syncbyte)))) 
             & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r)))) {
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__even_r = 0U;
        }
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__ov_fl_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__ov_fl_r = 0U;
    } else {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__ov_fl_r 
            = (3U & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__q_o_r) 
                     >> 2U));
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__ov_fl_r 
            = (3U & ((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__q_o_r) 
                     >> 2U));
    }
    ...
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r 
        = __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__sync_r;
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__q_o_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__q_o_r = 0U;
    } else {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__q_o_r 
            = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane1__DOT__ddr;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__lane0__DOT__q_o_r 
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__13(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    // Body
    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r;
    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r;
    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter;
    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r;
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r = 0U;
    } else {
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync) {
            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r 
                = (0xffffU & ((((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__ecc) 
                                == (0xffU & (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct 
                                             >> 0x18U))) 
                               & (0U != vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct))
                               ? (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct 
                                  >> 8U) : (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r)));
        }
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r = 0U;
    } else {
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync) {
            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r 
                = (0x3fU & ((((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__ecc) 
                              == (0xffU & (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct 
                                           >> 0x18U))) 
                             & (0U != vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct))
                             ? vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct
                             : (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r)));
        }
    }
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r = 0U;
    } else {
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync) {
            __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r 
                = ((((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__ecc) 
                     == (0xffU & (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct 
                                  >> 0x18U))) & (0U 
                                                 != vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct))
                    ? 1U : (1U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r)));
        }
    }
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__div8__DOT__counter 
        = ((IData)(vlTOPp->reset) ? 0U : (0xffU & ((IData)(1U) 
                                                   + (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__div8__DOT__counter))));
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r 
        = __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__valid_r;
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__15(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    CData/*0:0*/ __Vdlyvset__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0;
    SData/*15:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__c;
    IData/*31:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr;
    IData/*31:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cX_r;
    IData/*31:0*/ __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cY_r;
    IData/*16:0*/ __Vdlyvdim0__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0;
    IData/*31:0*/ __Vdlyvval__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0;
    // Body
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cY_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cY_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cX_r 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cX_r;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__state 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__state;
    __Vdlyvset__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0 = 0U;
    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__c 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__c;
    if (vlTOPp->btn) {
        vlTOPp->ulx3s_pass_through_sim__DOT__DPR__DOT____Vlvbound1 
            = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__data_o_r;
        if ((0x12bffU >= (0x1ffffU & vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr))) {
            __Vdlyvval__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0 
                = vlTOPp->ulx3s_pass_through_sim__DOT__DPR__DOT____Vlvbound1;
            __Vdlyvset__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0 = 1U;
            __Vdlyvdim0__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0 
                = (0x1ffffU & vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr);
        }
    }
    if (__Vdlyvset__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0) {
        vlTOPp->ulx3s_pass_through_sim__DOT__DPR__DOT__ram[__Vdlyvdim0__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0] 
            = __Vdlyvval__ulx3s_pass_through_sim__DOT__DPR__DOT__ram__v0;
    }
    if (vlTOPp->reset) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__rec_data_r = 0U;
        __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__state = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__data_o_r = 0U;
        ...
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__state) {
            if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__state) {
                if ((vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter 
                     < vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__count_val)) {
                    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cX_r 
                        = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cX_r);
                    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr 
                        = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr);
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter 
                        = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter);
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__rec_data_r = 1U;
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__data_o_r 
                    ...
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter = 0U;
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__rec_data_r = 0U;
                    __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__state = 0U;
            ...
            __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__c = 0xffffU;
            if (((((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__valid) 
                  ...
                  & ((0U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r)) 
                     | (1U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r)))) 
                 | (0x12bffU < vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr))) {
                __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__counter_addr = 0U;
                __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cX_r = 0U;
                __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cY_r = 0U;
            ...
            if (((((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__valid) 
                   & (~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__valid_old))) 
                  & (0x2aU == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__type_o_r))) 
                 & (0x280U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r)))) {
                __Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cY_r 
                    = ((IData)(0x280U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__Prot__DOT__cY_r);
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__16(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r 
        = vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__wordcount_r;
    if (((IData)(vlTOPp->reset) | (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r))) {
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__start = 0U;
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r_old = 0U;
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__data_r = 0U;
    } else {
        if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__sync) {
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r_old 
                = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r;
            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r 
                = (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL1__DOT__byte_o_r) 
                    << 0x18U) | (((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__BAL0__DOT__byte_o_r) 
                                  << 0x10U) | (0xffffU 
                                               & (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r 
                                                  >> 0x10U))));
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__start 
                = ((((IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__ecc) 
                     == (0xffU & (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct 
                                  >> 0x18U))) & (0U 
                                                 != vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__regheader_correct))
                    ? 1U : (1U & (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__start)));
            if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__start) {
                vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter 
                    = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter);
                if ((1U & ((~ vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter) 
                           & (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter 
                              >> 1U)))) {
                    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter = 1U;
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__data_r 
                        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__out_r;
                } else {
                    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__DE__DOT__counter 
...
VL_INLINE_OPT void Vulx3s_pass_through_sim::_sequent__TOP__18(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    ...
    // Body
    if (vlTOPp->reset) {
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 0U;
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou = 0U;
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_term = 0U;
        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_hs = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__term_r = 0U;
        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r = 1U;
    } else {
        if ((0U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi))) {
            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi 
            ...
            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_hs = 0U;
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__term_r = 0U;
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__debug0_r = 0U;
            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r = 1U;
        } else {
            if ((1U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi))) {
                vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi 
                    = (((((~ (IData)(vlTOPp->cam0_d0_r_p)) 
                          & (IData)(vlTOPp->cam0_d0_r_n)) 
                         & (~ (IData)(vlTOPp->cam0_d1_r_p))) 
                ...
                if ((2U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi))) {
                    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_term 
                        = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_term);
                    if ((0x181U <= vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou)) {
                        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 0U;
                    } else {
                        if ((1U & ((((~ (IData)(vlTOPp->cam0_d0_r_p)) 
                                    ...
                                    & (~ (IData)(vlTOPp->cam0_d1_r_p))) 
                                   & (~ (IData)(vlTOPp->cam0_d1_r_n))))) {
                            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 3U;
                            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou = 0U;
                            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_hs = 0U;
                        }
                    }
                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r = 1U;
                    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou 
                        = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou);
                } else {
                    if ((3U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi))) {
                        vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r = 1U;
                        if (VL_LTES_III(1,32,32, 0U, vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_term)) {
                            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__term_r = 1U;
                        }
                        if (VL_LTES_III(1,32,32, 1U, vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_hs)) {
                            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 4U;
                            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou = 0U;
                            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r = 0U;
                        }
                        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_term 
                            = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_term);
                        if ((0x181U <= vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou)) {
                        ...
                        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou 
                            = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou);
                        vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_hs 
                            = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_hs);
                    } else {
                        if ((4U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi))) {
                            vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__debug0_r = 1U;
                            if ((0x181U <= vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou)) {
                                vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 0U;
                                vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__stop_rx_r = 1U;
                            }
                            vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou 
                                = ((IData)(1U) + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou);
                            if (vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__rec_data) {
                                vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 5U;
                                vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou = 0U;
                            }
                        } else {
                            if ((5U == (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi))) {
                                vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou 
                                    = ((IData)(1U) 
                                       + vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou);
                                if ((1U & ((~ (IData)(vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__rec_data)) 
                                           | (0x181U 
                                              < vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__timer_tou)))) {
                                    vlTOPp->__Vdly__ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__state_mipi = 0U;
                                    vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__RxFSM__DOT__term_r = 0U;
...
void Vulx3s_pass_through_sim::_eval(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
...
VL_INLINE_OPT QData Vulx3s_pass_through_sim::_change_request(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vulx3s_pass_through_sim::_change_request\n"); );
    Vulx3s_pass_through_sim* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    return (vlTOPp->_change_request_1(vlSymsp));
}

VL_INLINE_OPT QData Vulx3s_pass_through_sim::_change_request_1(Vulx3s_pass_through_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vulx3s_pass_through_sim::_change_request_1\n"); );
    Vulx3s_pass_through_sim* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
    QData __req = false;  // Logically a bool
    __req |= ((vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2 ^ vlTOPp->__Vchglast__TOP__ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2));
    VL_DEBUG_IF( if(__req && ((vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2 ^ vlTOPp->__Vchglast__TOP__ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2))) VL_DBG_MSGF("        CHANGE: MIPI/IDDR2/ECLKSYNCB.v:2: ulx3s_pass_through_sim.mipi.SYNC.eclki_r2\n"); );
    // Final
    vlTOPp->__Vchglast__TOP__ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2 
        = vlTOPp->ulx3s_pass_through_sim__DOT__mipi__DOT__SYNC__DOT__eclki_r2;
    return __req;
}

#ifdef VL_DEBUG
void Vulx3s_pass_through_sim::_eval_debug_assertions() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vulx3s_pass_through_sim::_eval_debug_assertions\n"); );
    // Body

...
void VMIPI_Reciever::_initial__TOP__4(VMIPI_Reciever__Syms* __restrict vlSymsp) {
    ...
    VMIPI_Reciever* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->MIPI_Reciever__DOT__lane1__DOT__sync_r = 0U;
    vlTOPp->MIPI_Reciever__DOT__Prot__DOT__c = 0xffffU;
    vlTOPp->MIPI_Reciever__DOT__lane0__DOT__sync_r = 0U;
...
void VMIPI_Reciever::_settle__TOP__5(VMIPI_Reciever__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMIPI_Reciever::_settle__TOP__5\n"); );
    VMIPI_Reciever* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VMIPI_Reciever::_settle__TOP__8(VMIPI_Reciever__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMIPI_Reciever::_settle__TOP__8\n"); );
    VMIPI_Reciever* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VMIPI_Reciever::_ctor_var_reset() {
    ...
    address_out = VL_RAND_RESET_I(32);
    ...
    MIPI_Reciever__DOT__mipi_clk_2 = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__mipi_clk_4 = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__mipi_clk_8 = VL_RAND_RESET_I(1);
    ...
    MIPI_Reciever__DOT__lane0__DOT__byte_r = VL_RAND_RESET_I(8);
    MIPI_Reciever__DOT__lane0__DOT__sync_r = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__lane0__DOT__q_o_r = VL_RAND_RESET_I(2);
    MIPI_Reciever__DOT__lane0__DOT__ddr = VL_RAND_RESET_I(2);
    MIPI_Reciever__DOT__lane0__DOT__l0__DOT__Q0_r = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__lane0__DOT__l0__DOT__Q1_r = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__lane1__DOT__byte_r = VL_RAND_RESET_I(8);
    MIPI_Reciever__DOT__lane1__DOT__sync_r = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__lane1__DOT__q_o_r = VL_RAND_RESET_I(2);
    MIPI_Reciever__DOT__lane1__DOT__ddr = VL_RAND_RESET_I(2);
    MIPI_Reciever__DOT__lane1__DOT__l0__DOT__Q0_r = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__lane1__DOT__l0__DOT__Q1_r = VL_RAND_RESET_I(1);
    MIPI_Reciever__DOT__BA0__DOT__byte_r = VL_RAND_RESET_I(8);
    MIPI_Reciever__DOT__BA1__DOT__byte_r = VL_RAND_RESET_I(8);
    ...
    __Vdly__MIPI_Reciever__DOT__lane0__DOT__sync_r = VL_RAND_RESET_I(1);

...
VL_INLINE_OPT void VHDMI_test::_sequent__TOP__4(VHDMI_test__Syms* __restrict vlSymsp) {
    ...
    VHDMI_test* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->__Vdly__HDMI_test__DOT__CounterX = vlTOPp->HDMI_test__DOT__CounterX;
    vlTOPp->__Vdly__HDMI_test__DOT__CounterY = vlTOPp->HDMI_test__DOT__CounterY;
    vlTOPp->__Vdly__HDMI_test__DOT__CounterX = ((0x31fU 
    ...
    if ((0x31fU == (IData)(vlTOPp->HDMI_test__DOT__CounterX))) {
        vlTOPp->__Vdly__HDMI_test__DOT__CounterY = 
            ((0x20cU == (IData)(vlTOPp->HDMI_test__DOT__CounterY))
              ? 0U : (0x3ffU & ((IData)(1U) + (IData)(vlTOPp->HDMI_test__DOT__CounterY))));
    }
    ...
    vlTOPp->HDMI_test__DOT__blue = 0xffU;
    vlTOPp->HDMI_test__DOT__green = 0xffU;
    vlTOPp->HDMI_test__DOT__red = 0xffU;
...
VL_INLINE_OPT void VHDMI_test::_sequent__TOP__8(VHDMI_test__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VHDMI_test::_sequent__TOP__8\n"); );
    VHDMI_test* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    if (vlTOPp->HDMI_test__DOT__DrawArea) {
    ...
    vlTOPp->HDMI_test__DOT__CounterY = vlTOPp->__Vdly__HDMI_test__DOT__CounterY;
    vlTOPp->HDMI_test__DOT__CounterX = vlTOPp->__Vdly__HDMI_test__DOT__CounterX;
}

VL_INLINE_OPT void VHDMI_test::_combo__TOP__9(VHDMI_test__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VHDMI_test::_combo__TOP__9\n"); );
    VHDMI_test* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT QData VHDMI_test::_change_request_1(VHDMI_test__Syms* __restrict vlSymsp) {
    ...
    VL_DEBUG_IF( if(__req && ((vlTOPp->HDMI_test__DOT__encode_R__DOT__q_m ^ vlTOPp->__Vchglast__TOP__HDMI_test__DOT__encode_R__DOT__q_m))) VL_DBG_MSGF("        CHANGE: HDMI_test.v:80: HDMI_test.encode_R.q_m\n"); );
    VL_DEBUG_IF( if(__req && ((vlTOPp->HDMI_test__DOT__encode_G__DOT__q_m ^ vlTOPp->__Vchglast__TOP__HDMI_test__DOT__encode_G__DOT__q_m))) VL_DBG_MSGF("        CHANGE: HDMI_test.v:80: HDMI_test.encode_G.q_m\n"); );
    VL_DEBUG_IF( if(__req && ((vlTOPp->HDMI_test__DOT__encode_B__DOT__q_m ^ vlTOPp->__Vchglast__TOP__HDMI_test__DOT__encode_B__DOT__q_m))) VL_DBG_MSGF("        CHANGE: HDMI_test.v:80: HDMI_test.encode_B.q_m\n"); );
    // Final

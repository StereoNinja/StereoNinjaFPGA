...
void VMIPI_Reciever::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[5U])) {
            ...
            tracep->chgSData(oldp+48,(vlTOPp->MIPI_Reciever__DOT__Prot__DOT__c),16);
            tracep->chgSData(oldp+49,(vlTOPp->MIPI_Reciever__DOT__Prot__DOT__c_calk),16);
        }
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[6U])) {
            tracep->chgIData(oldp+50,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__data_r),32);
            tracep->chgBit(oldp+51,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__valid_r));
            tracep->chgCData(oldp+52,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__type_o_r),6);
            tracep->chgSData(oldp+53,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__wordcount_r),16);
            tracep->chgIData(oldp+54,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__out_r),32);
            tracep->chgBit(oldp+55,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__start));
            tracep->chgCData(oldp+56,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__counter),8);
            tracep->chgCData(oldp+57,(vlTOPp->MIPI_Reciever__DOT__DE__DOT__ecc),8);
            tracep->chgBit(oldp+58,((1U & ((IData)(vlTOPp->MIPI_Reciever__DOT__DE__DOT__ecc) 
                                           ^ (vlTOPp->MIPI_Reciever__DOT__DE__DOT__out_r 
                                              >> 0x18U)))));
        }
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[7U])) {
            tracep->chgBit(oldp+59,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__stop_rx_r));
            tracep->chgCData(oldp+60,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__state_mipi),8);
            tracep->chgBit(oldp+61,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__term_r));
            tracep->chgBit(oldp+62,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__debug0_r));
            tracep->chgIData(oldp+63,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__timer_tou),32);
            tracep->chgIData(oldp+64,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__timer_term),32);
            tracep->chgIData(oldp+65,(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__timer_hs),32);
        }
        tracep->chgBit(oldp+66,(vlTOPp->sys_clk));
        tracep->chgBit(oldp+67,(vlTOPp->reset));
        tracep->chgBit(oldp+68,(vlTOPp->lane0_d));
        tracep->chgBit(oldp+69,(vlTOPp->mipi_clk));
        tracep->chgBit(oldp+70,(vlTOPp->mipi_clk_8));
        tracep->chgBit(oldp+71,(vlTOPp->lane1_d));
        tracep->chgBit(oldp+72,(vlTOPp->lane0_p));
        tracep->chgBit(oldp+73,(vlTOPp->lane0_n));
        tracep->chgBit(oldp+74,(vlTOPp->lane1_p));
        tracep->chgBit(oldp+75,(vlTOPp->lane1_n));
        tracep->chgIData(oldp+76,(vlTOPp->data_o),32);
        tracep->chgIData(oldp+77,(vlTOPp->adress_out),32);
        tracep->chgBit(oldp+78,(vlTOPp->ram_clk));
        tracep->chgBit(oldp+79,(vlTOPp->debug0));
        tracep->chgBit(oldp+80,(vlTOPp->debug1));
        tracep->chgBit(oldp+81,(vlTOPp->debug2));
        tracep->chgBit(oldp+82,(vlTOPp->termination));
        tracep->chgBit(oldp+83,(vlTOPp->rec_data_o));
        tracep->chgIData(oldp+84,(vlTOPp->cX),32);
        tracep->chgIData(oldp+85,(vlTOPp->cY),32);
        tracep->chgBit(oldp+86,(vlTOPp->MIPI_Reciever__DOT__rec_data));
        tracep->chgBit(oldp+87,(vlTOPp->MIPI_Reciever__DOT__sync));
        tracep->chgBit(oldp+88,(vlTOPp->MIPI_Reciever__DOT__sync_mipi_clk_8));
        tracep->chgCData(oldp+89,(vlTOPp->MIPI_Reciever__DOT__BAL0__DOT__byte_o_r),8);
        tracep->chgCData(oldp+90,(vlTOPp->MIPI_Reciever__DOT__BAL1__DOT__byte_o_r),8);
        tracep->chgCData(oldp+91,(vlTOPp->MIPI_Reciever__DOT__div8__DOT__counter),8);
        tracep->chgCData(oldp+92,(vlTOPp->MIPI_Reciever__DOT__lane0__DOT__ddr),4);
        tracep->chgBit(oldp+93,(((IData)(vlTOPp->MIPI_Reciever__DOT__lane1__DOT__sync_r) 
                                 & (~ (IData)(vlTOPp->MIPI_Reciever__DOT__RxFSM__DOT__stop_rx_r)))));
        tracep->chgCData(oldp+94,(vlTOPp->MIPI_Reciever__DOT__lane1__DOT__ddr),4);
    }
}

...
VL_MODULE(VMIPI_Reciever) {
  public:
    ...
    struct {
        ...
        IData/*23:0*/ MIPI_Reciever__DOT__DE__DOT__regheader_correct;
  ...
  public:
    ...
    static void _initial__TOP__1(VMIPI_Reciever__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void _settle__TOP__4(VMIPI_Reciever__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:

...
void VMIPI_Reciever::_initial__TOP__1(VMIPI_Reciever__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMIPI_Reciever::_initial__TOP__1\n"); );
    VMIPI_Reciever* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->MIPI_Reciever__DOT__Prot__DOT__c = 0U;
...
void VMIPI_Reciever::_settle__TOP__4(VMIPI_Reciever__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMIPI_Reciever::_settle__TOP__4\n"); );
    VMIPI_Reciever* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VMIPI_Reciever::_ctor_var_reset() {
    ...
    MIPI_Reciever__DOT__DE__DOT__regheader_correct = VL_RAND_RESET_I(24);
